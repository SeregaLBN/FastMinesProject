...
public final class Smile {
    ...
    /** Smile images. Base image view SWING implementation
     * @param <TImage> SWING specific image: {@link java.awt.Image} or {@link javax.swing.Icon})
     **/
    public abstract static class SwingView<TImage> extends ImageView<TImage, SmileModel> {

        protected SwingView(EFaceType faceType) {
    ...
    static class IconView extends SwingView<javax.swing.Icon> {
        ...
        public IconView(EFaceType faceType) { super(faceType); }
    ...
    static class ImageAwtView extends SwingView<java.awt.Image> {
        ...
        public ImageAwtView(EFaceType faceType) { super(faceType); }
    ...
    /** Smile image controller implementation for {@link Smile.IconView} */
    public static class IconController extends ImageController<javax.swing.Icon, Smile.IconView, SmileModel> {

        public IconController(EFaceType faceType) {
            super(new Smile.IconView(faceType));
        }
    ...
    /** Smile image controller implementation for {@link Smile.ImageAwtView} */
    public static class ImageAwtController extends ImageController<java.awt.Image, Smile.ImageAwtView, SmileModel> {

        public ImageAwtController(EFaceType faceType) {
            super(new Smile.ImageAwtView(faceType));
        }
