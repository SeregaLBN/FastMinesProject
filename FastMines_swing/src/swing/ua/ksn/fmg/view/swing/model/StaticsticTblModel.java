...
import ua.ksn.fmg.controller.serializable.StatisticCounts;
...
public class StaticsticTblModel extends ReportTableModel {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case 3: return formatter.format(sc.openField*100./Math.max(1, sc.gameNumber) / (eSkill.DefaultSize().width*eSkill.DefaultSize().height)) + '%';
