...
public final class Smile2 {
    ...
    private static void drawEyes(Canvas g, SmileModel2 sm) {
        ...
        case Eyes_OpenDisabled:
            eyeOpened(g,  true, true, paintFill, sm);
            eyeOpened(g, false, true, paintFill, sm);
            break;
        case Eyes_ClosedDisabled:
            eyeClosed(g,  true, true, paintFill, sm);
            eyeClosed(g, false, true, paintFill, sm);
            break;
        case Face_EyesOpen:
            eyeOpened(g,  true, false, paintFill, sm);
            eyeOpened(g, false, false, paintFill, sm);
            break;
        case Face_WinkingEyeLeft:
            eyeClosed(g,  true, false, paintFill, sm);
            eyeOpened(g, false, false, paintFill, sm);
            break;
        case Face_WinkingEyeRight:
            eyeOpened(g,  true, false, paintFill, sm);
            eyeClosed(g, false, false, paintFill, sm);
            break;
