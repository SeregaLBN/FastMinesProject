...
import fmg.core.mosaic.shape.ShapePenrousePeriodic1;
...
public class PenrousePeriodic1 extends BaseCell {
    ...
    public PenrousePeriodic1(ShapePenrousePeriodic1 shape, Coord coord) {
        super(shape, coord,
    ...
    @Override
    public ShapePenrousePeriodic1 getShape() {
        return (ShapePenrousePeriodic1)super.getShape();
    }
    ...
    public List<Coord> getCoordsNeighbor() {
        ...
        { // debug check
            if (neighborCoord.size() != getShape().getNeighborNumber(direction))
                throw new RuntimeException("Исправь ShapePenrousePeriodic1.getNeighborNumber("+direction+")...");
        }
...
//                neighborCoord[i] = Coord.INCORRECT_COORD;
    ...
    protected void calcRegion() {
        ShapePenrousePeriodic1 shape = getShape();
        double a = shape.getA();
        double c = shape.getC();
        double e = shape.getE();
        double f = shape.getF();
