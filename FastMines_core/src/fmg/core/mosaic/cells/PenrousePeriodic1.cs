...
namespace Fmg.Core.Mosaic.Cells {
    ...
    public class PenrousePeriodic1 : BaseCell {
        ...
        private new ShapePenrousePeriodic1 Shape => (ShapePenrousePeriodic1)base.Shape;
        ...
        public override IList<Coord> GetCoordsNeighbor() {
            ...
            { // debug check
                ...
                if (neighborCoord[i] == null)
                    break;
                if (i != Shape.GetNeighborNumber(direction))
                throw new Exception("Исправь ShapePenrousePeriodic1.getNeighborNumber("+direction+")...");
            }
#endif
