...
public final class PropertyConst {
    ...
    public static final String PROPERTY_FOREGROUND_ANGLE          = "ForegroundAngle";
    ...
    public static final String PROPERTY_PALETTE_COLOR_OFFSET      = "PaletteColorOffset";
    public static final String PROPERTY_ROTATE_FULL_MATRIX        = "RotateFullMatrix";
    ...
    public static final String PROPERTY_BURGER_MENU               = "BurgerMenu";
    public static final String PROPERTY_BURGER_MENU_DOT           = PROPERTY_BURGER_MENU + ".";
    public static final String PROPERTY_MODEL_BURGER_MENU_PADDING = PROPERTY_MODEL_DOT + PROPERTY_BURGER_MENU_DOT + PROPERTY_PADDING;
