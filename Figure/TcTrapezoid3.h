...
// file name: "TcTrapezoid3.h"
//
// Описание класса TcTrapezoid3
////////////////////////////////////////////////////////////////////////////////

#ifndef FILE_TCTRAPEZOID3
#define FILE_TCTRAPEZOID3
...
private:
   POINT neighbor[11]; // кординаты соседей; если соседа нет, то координаты отрицательны
   POINTFLOAT regionOut[4]; // координаты 4x точек из которых состоит фигура
   int direction; // 0..15
public:
   TcTrapezoid3(const POINT&, const POINT&, const int&);
