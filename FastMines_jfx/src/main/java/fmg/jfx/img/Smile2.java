...
public final class Smile2 {
    ...
    private static void drawEyes(GraphicsContext g, SmileModel2 sm) {
        ...
        case Eyes_OpenDisabled:
            eyeOpened(g, true, true, sm);
            eyeOpened(g, false, true, sm);
            break;
        case Eyes_ClosedDisabled:
            eyeClosed(g, true, true, sm);
            eyeClosed(g, false, true, sm);
            break;
        case Face_EyesOpen:
            eyeOpened(g, true, false, sm);
            eyeOpened(g, false, false, sm);
            break;
        case Face_WinkingEyeLeft:
            eyeClosed(g, true, false, sm);
            eyeOpened(g, false, false, sm);
            break;
        case Face_WinkingEyeRight:
            eyeOpened(g, true, false, sm);
            eyeClosed(g, false, false, sm);
            break;
