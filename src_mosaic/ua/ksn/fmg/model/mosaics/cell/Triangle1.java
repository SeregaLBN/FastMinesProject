...
/**
 * “реугольник. ¬ариант 1 - равносторонний, классика 
 * @see BaseCell
 **/
public class Triangle1 extends BaseCell {
	...
	protected void CalcRegion() {
		...
		case 2:
			...
			region.getPoint(1).x = (int)(oX +   b); region.getPoint(1).y = (int)(oY + h);
			region.getPoint(2).x = (int)(oX      ); region.getPoint(2).y = (int)(oY    );
			break;
		case 3:
			region.getPoint(0).x = (int)(oX + a  ); region.getPoint(0).y = (int)(oY    );
			region.getPoint(1).x = (int)(oX + a+b); region.getPoint(1).y = (int)(oY + h);
			region.getPoint(2).x = (int)(oX +   b); region.getPoint(2).y = (int)(oY + h);
			break;
		}
	}
