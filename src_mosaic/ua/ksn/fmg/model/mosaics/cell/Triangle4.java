...
//
// –еализаци€ класса Triangle4 - треугольник 30∞-30∞-120∞
...
/**
 * “реугольник. ¬ариант 4 - треугольник 30∞-30∞-120∞
 * @see BaseCell
 **/
...
//		}
	...
	protected void CalcRegion() {
		...
		case 0:
			...
			region.getPoint(0).x = (int)(oX    ); region.getPoint(0).y = (int)(oY - R-r);
			break;
		case 1:
			region.getPoint(0).x = (int)(oX + b); region.getPoint(0).y = (int)(oY - R  );
			region.getPoint(2).x = (int)(oX    ); region.getPoint(2).y = (int)(oY - R-r);
			region.getPoint(1).x = (int)(oX + b); region.getPoint(1).y = (int)(oY      );
			break;
		case 2:
			region.getPoint(2).x = (int)(oX    ); region.getPoint(2).y = (int)(oY - R-r);
			region.getPoint(1).x = (int)(oX + b); region.getPoint(1).y = (int)(oY - R  );
			region.getPoint(0).x = (int)(oX + a); region.getPoint(0).y = (int)(oY - R-r);
			break;
		case 3:
		...
		case 5:
			region.getPoint(0).x = (int)(oX + a); region.getPoint(0).y = (int)(oY - R-r);
			region.getPoint(2).x = (int)(oX + b); region.getPoint(2).y = (int)(oY - R  );
			region.getPoint(1).x = (int)(oX + b); region.getPoint(1).y = (int)(oY      );
			break;
		case 6:
			region.getPoint(2).x = (int)(oX - b); region.getPoint(2).y = (int)(oY      );
		...
		case 7:
			region.getPoint(0).x = (int)(oX + b); region.getPoint(0).y = (int)(oY      );
			region.getPoint(2).x = (int)(oX    ); region.getPoint(2).y = (int)(oY + r  );
			region.getPoint(1).x = (int)(oX    ); region.getPoint(1).y = (int)(oY + R+r);
			break;
		case 8:
			region.getPoint(2).x = (int)(oX + b); region.getPoint(2).y = (int)(oY + R  );
			region.getPoint(1).x = (int)(oX + a); region.getPoint(1).y = (int)(oY + R+r);
			region.getPoint(0).x = (int)(oX + b); region.getPoint(0).y = (int)(oY      );
			break;
		case 9:
