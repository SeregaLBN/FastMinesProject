		...
		public Size CalcOwnerSize(Size sizeField, int area) {
			...
			if (sizeField.width < 14) { // ...нужно вычисл€ть не только по общей формуле, а и убрать остатки снизу..
				if ((sizeField.height & 1) == 0) {
					...
					if (sizeField.width <  5) result.height -= h;
					if (sizeField.width <  2) result.height -= h;
				} else {
					if (sizeField.width < 10) result.height -= h;
					if (sizeField.width <  7) result.height -= h;
					if (sizeField.width <  4) result.height -= h;
				}
...
//			return 1;
	...
	protected void CalcRegion() {
		...
		case  0: case  3: case  6: case  9: case 12: case 28: case 31: case 34: case 37: case 54: case 56: case 59: case 62: case 65:
			region.getPoint(0).x = (int)(oX - a    ); region.getPoint(0).y = (int)(oY - h*2);
			region.getPoint(1).x = (int)(oX        ); region.getPoint(1).y = (int)(oY      );
			region.getPoint(2).x = (int)(oX - a*2  ); region.getPoint(2).y = (int)(oY      );
			region.getPoint(3).x = (int)(oX - a*2.5); region.getPoint(3).y = (int)(oY - h  );
			region.getPoint(4).x = (int)(oX - a*2  ); region.getPoint(4).y = (int)(oY - h*2);
			break;
		case  1: case  4: case  7: case 10: case 13: case 29: case 32: case 35: case 38: case 55: case 57: case 60: case 63: case 66:
			region.getPoint(0).x = (int)(oX + a*0.5); region.getPoint(0).y = (int)(oY - h*3);
			region.getPoint(1).x = (int)(oX + a    ); region.getPoint(1).y = (int)(oY - h*2);
			region.getPoint(2).x = (int)(oX        ); region.getPoint(2).y = (int)(oY      );
			region.getPoint(3).x = (int)(oX - a    ); region.getPoint(3).y = (int)(oY - h*2);
			region.getPoint(4).x = (int)(oX - a*0.5); region.getPoint(4).y = (int)(oY - h*3);
			break;
		case  2: case  5: case  8: case 11: case 27: case 30: case 33: case 36: case 39: case 69: case 58: case 61: case 64: case 82:
			region.getPoint(0).x = (int)(oX + a*2  ); region.getPoint(0).y = (int)(oY - h*2);
			region.getPoint(1).x = (int)(oX + a*2.5); region.getPoint(1).y = (int)(oY - h  );
			region.getPoint(2).x = (int)(oX + a*2  ); region.getPoint(2).y = (int)(oY      );
			region.getPoint(3).x = (int)(oX        ); region.getPoint(3).y = (int)(oY      );
			region.getPoint(4).x = (int)(oX + a    ); region.getPoint(4).y = (int)(oY - h*2);
			break;
		case 14: case 17: case 20: case 23: case 26: case 42: case 45: case 48: case 51: case 67: case 70: case 73: case 76: case 79:
			...
			region.getPoint(1).x = (int)(oX - a    ); region.getPoint(1).y = (int)(oY + h*2);
			region.getPoint(2).x = (int)(oX - a*2  ); region.getPoint(2).y = (int)(oY + h*2);
			region.getPoint(3).x = (int)(oX - a*2.5); region.getPoint(3).y = (int)(oY + h  );
			region.getPoint(4).x = (int)(oX - a*2  ); region.getPoint(4).y = (int)(oY      );
			break;
		case 15: case 18: case 21: case 24: case 40: case 43: case 46: case 49: case 52: case 68: case 71: case 74: case 77: case 80:
			region.getPoint(0).x = (int)(oX        ); region.getPoint(0).y = (int)(oY      );
			region.getPoint(1).x = (int)(oX + a    ); region.getPoint(1).y = (int)(oY + h*2);
			region.getPoint(2).x = (int)(oX + a*0.5); region.getPoint(2).y = (int)(oY + h*3);
			region.getPoint(3).x = (int)(oX - a*0.5); region.getPoint(3).y = (int)(oY + h*3);
			region.getPoint(4).x = (int)(oX - a    ); region.getPoint(4).y = (int)(oY + h*2);
			break;
		case 16: case 19: case 22: case 25: case 41: case 44: case 47: case 50: case 53: case 83: case 72: case 75: case 78: case 81:
			region.getPoint(0).x = (int)(oX + a*2  ); region.getPoint(0).y = (int)(oY      );
			region.getPoint(1).x = (int)(oX + a*2.5); region.getPoint(1).y = (int)(oY + h  );
			region.getPoint(2).x = (int)(oX + a*2  ); region.getPoint(2).y = (int)(oY + h*2);
			region.getPoint(3).x = (int)(oX + a    ); region.getPoint(3).y = (int)(oY + h*2);
			region.getPoint(4).x = (int)(oX        ); region.getPoint(4).y = (int)(oY      );
			break;
		}
	}
