...
public class TrSq1 extends BaseCell {
	...
	protected void CalcRegion() {
		...
		case 0:
			...
			region.getPoint(2).x = (int)(oX - n  ); region.getPoint(2).y = (int)(oY + m);
			region.getPoint(3).x = (int)(oX - b  ); region.getPoint(3).y = (int)(oY - k);
			break;
		case 1:                            
			region.getPoint(1).x = (int)(oX      ); region.getPoint(1).y = (int)(oY    );
			region.getPoint(2).x = (int)(oX - m  ); region.getPoint(2).y = (int)(oY - n);
			region.getPoint(0).x = (int)(oX + k  ); region.getPoint(0).y = (int)(oY - k);
			break;
		case 2:                            
			region.getPoint(0).x = (int)(oX + k  ); region.getPoint(0).y = (int)(oY - k);
			region.getPoint(1).x = (int)(oX + n  ); region.getPoint(1).y = (int)(oY + m);
		...
		case 3:                            
			...
			break;
		case 4:                            
			region.getPoint(0).x = (int)(oX + n  ); region.getPoint(0).y = (int)(oY + m);
			region.getPoint(3).x = (int)(oX      ); region.getPoint(3).y = (int)(oY    );
			region.getPoint(2).x = (int)(oX - m  ); region.getPoint(2).y = (int)(oY + n);
			region.getPoint(1).x = (int)(oX + k  ); region.getPoint(1).y = (int)(oY + b);
			break;
		case 5:                            
			region.getPoint(0).x = (int)(oX + n  ); region.getPoint(0).y = (int)(oY + m);
			region.getPoint(1).x = (int)(oX + n+k); region.getPoint(1).y = (int)(oY + n);
			region.getPoint(2).x = (int)(oX + k  ); region.getPoint(2).y = (int)(oY + b);
			break;
		}
	}
