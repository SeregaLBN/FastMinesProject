...
//
// –еализаци€ класса Parquet2 - ещЄ один паркет
...
public class Parquet2 extends BaseCell {
	...
	protected void CalcRegion() {
		...
		switch (direction) {
		case 0:
			region.getPoint(0).x = (int) ((2 * coord.x + 2) * a); region.getPoint(0).y = (int) ((2 * coord.y + 0) * a);
			region.getPoint(1).x = (int) ((2 * coord.x + 4) * a); region.getPoint(1).y = (int) ((2 * coord.y + 2) * a);
			region.getPoint(2).x = (int) ((2 * coord.x + 3) * a); region.getPoint(2).y = (int) ((2 * coord.y + 3) * a);
			region.getPoint(3).x = (int) ((2 * coord.x + 1) * a); region.getPoint(3).y = (int) ((2 * coord.y + 1) * a);
			break;
		case 1:
			region.getPoint(0).x = (int) ((2 * coord.x + 3) * a); region.getPoint(0).y = (int) ((2 * coord.y + 1) * a);
			region.getPoint(1).x = (int) ((2 * coord.x + 4) * a); region.getPoint(1).y = (int) ((2 * coord.y + 2) * a);
			region.getPoint(2).x = (int) ((2 * coord.x + 2) * a); region.getPoint(2).y = (int) ((2 * coord.y + 4) * a);
			region.getPoint(3).x = (int) ((2 * coord.x + 1) * a); region.getPoint(3).y = (int) ((2 * coord.y + 3) * a);
			break;
		case 2:
			region.getPoint(0).x = (int) ((2 * coord.x + 2) * a); region.getPoint(0).y = (int) ((2 * coord.y + 0) * a);
			region.getPoint(1).x = (int) ((2 * coord.x + 3) * a); region.getPoint(1).y = (int) ((2 * coord.y + 1) * a);
			region.getPoint(2).x = (int) ((2 * coord.x + 1) * a); region.getPoint(2).y = (int) ((2 * coord.y + 3) * a);
			region.getPoint(3).x = (int) ((2 * coord.x + 0) * a); region.getPoint(3).y = (int) ((2 * coord.y + 2) * a);
			break;
		case 3:
			region.getPoint(0).x = (int) ((2 * coord.x + 1) * a); region.getPoint(0).y = (int) ((2 * coord.y + 1) * a);
			region.getPoint(1).x = (int) ((2 * coord.x + 3) * a); region.getPoint(1).y = (int) ((2 * coord.y + 3) * a);
			region.getPoint(2).x = (int) ((2 * coord.x + 2) * a); region.getPoint(2).y = (int) ((2 * coord.y + 4) * a);
			region.getPoint(3).x = (int) ((2 * coord.x + 0) * a); region.getPoint(3).y = (int) ((2 * coord.y + 2) * a);
			break;
		}
