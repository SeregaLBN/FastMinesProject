...
/**
 *  вадрат. ¬ариант 2 - сдвинутые р€ды
 * @see BaseCell
 **/
public class Square2 extends BaseCell {
	...
	protected void CalcRegion() {
		...
		region.getPoint(3).x = region.getPoint(2).x = (int) (a*(coord.x+0) + ((direction!=0) ? 0 : a/2));
		region.getPoint(0).x = region.getPoint(1).x = (int) (a*(coord.x+1) + ((direction!=0) ? 0 : a/2));
