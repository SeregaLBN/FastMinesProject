...
//				System.out.println("PenrousePeriodic1::getVertexgetVertexNeighbor == " + vertexIntersection);
		...
		@Override
		protected double CalcA(int area) { return Math.sqrt(area*63/(39*SIN72 + 24*SIN36)); }
		protected double CalcB(int area) { return CalcA(area)+CalcC(area); }
		protected double CalcC(int area) { return CalcA(area)*SIN18; }
		protected double CalcE(int area) { return CalcH(area)+CalcC(area); }
		protected double CalcH(int area) { return CalcA(area)*SIN54; }
		protected double CalcF(int area) { return CalcH(area)-CalcC(area); }
		protected double CalcG(int area) { return CalcA(area)*SIN72; }
		protected double CalcZ(int area) { return CalcA(area)*SIN36; }
		protected double CalcK(int area) { return CalcZ(area)+CalcG(area); }
		@Override
...
//    			neighborCoord[i] = Coord.INCORRECT_COORD;
	...
	protected void CalcRegion() {
		...
		case 84: case 91: case 97: case 104: case 119: case 124:
			region.getPoint(0).x = (int)(left + k); region.getPoint(0).y = (int)(top + c);
			region.getPoint(1).x = (int)(left + g); region.getPoint(1).y = (int)(top + e);
			region.getPoint(2).x = (int)(left    ); region.getPoint(2).y = (int)(top + h);
			region.getPoint(3).x = (int)(left + z); region.getPoint(3).y = (int)(top    );
			break;
		case 1: case 4: case 27: case 33: case 48: case 74: case 90: case 114:
			region.getPoint(0).x = (int)(left + k); region.getPoint(0).y = (int)(top    );
			region.getPoint(1).x = (int)(left + g); region.getPoint(1).y = (int)(top + h);
			region.getPoint(2).x = (int)(left    ); region.getPoint(2).y = (int)(top + e);
			region.getPoint(3).x = (int)(left + z); region.getPoint(3).y = (int)(top + c);
			break;
		...
		case 73: case 78: case 85: case 98: case 101: case 105: case 120: case 125:
			region.getPoint(0).x = (int)(left+2*z); region.getPoint(0).y = (int)(top + h);
			region.getPoint(1).x = (int)(left + z); region.getPoint(1).y = (int)(top+2*h);
			region.getPoint(2).x = (int)(left    ); region.getPoint(2).y = (int)(top + h);
			region.getPoint(3).x = (int)(left + z); region.getPoint(3).y = (int)(top    );
			break;
		case 3: case 6: case 29: case 34: case 50: case 77: case 100: case 107:
			region.getPoint(0).x = (int)(left + k); region.getPoint(0).y = (int)(top + e);
			region.getPoint(1).x = (int)(left + z); region.getPoint(1).y = (int)(top + h);
			region.getPoint(2).x = (int)(left    ); region.getPoint(2).y = (int)(top    );
			region.getPoint(3).x = (int)(left + g); region.getPoint(3).y = (int)(top + c);
			break;
		...
		case 65: case 76: case 79: case 81: case 102: case 106: case 117: case 121:
			region.getPoint(0).x = (int)(left + k); region.getPoint(0).y = (int)(top + h);
			region.getPoint(1).x = (int)(left + z); region.getPoint(1).y = (int)(top + e);
			region.getPoint(2).x = (int)(left    ); region.getPoint(2).y = (int)(top + c);
			region.getPoint(3).x = (int)(left + g); region.getPoint(3).y = (int)(top   );
			break;
		case  8: case 20: case 32: case  55: case  60: case  75:
		case 80: case 83: case 87: case 103: case 118: case 123:
			region.getPoint(0).x = (int)(left+2*g); region.getPoint(0).y = (int)(top + c);
			region.getPoint(1).x = (int)(left + g); region.getPoint(1).y = (int)(top+2*c);
			region.getPoint(2).x = (int)(left    ); region.getPoint(2).y = (int)(top + c);
			region.getPoint(3).x = (int)(left + g); region.getPoint(3).y = (int)(top    );
			break;
		case  9: case 11: case 24: case 39: case 46: case  51: case  61: case 64:
		case 66: case 72: case 93: case 96: case 99: case 112: case 122:
			region.getPoint(0).x = (int)(left + g); region.getPoint(0).y = (int)(top    );
			region.getPoint(1).x = (int)(left + g); region.getPoint(1).y = (int)(top + a);
			region.getPoint(2).x = (int)(left    ); region.getPoint(2).y = (int)(top+a+c);
			region.getPoint(3).x = (int)(left    ); region.getPoint(3).y = (int)(top + c);
			break;
		case 13: case 16: case 38: case 53: case 59: case 71: case 88: case 95: case 110: case 115:
			region.getPoint(0).x = (int)(left + z); region.getPoint(0).y = (int)(top    );
			region.getPoint(1).x = (int)(left + z); region.getPoint(1).y = (int)(top + a);
			region.getPoint(2).x = (int)(left    ); region.getPoint(2).y = (int)(top+a+h);
			region.getPoint(3).x = (int)(left    ); region.getPoint(3).y = (int)(top + h);
			break;
		...
		case 69: case 86: case 89: case 92: case 109: case 111: case 116:
			region.getPoint(0).x = (int)(left + g); region.getPoint(0).y = (int)(top + c);
			region.getPoint(1).x = (int)(left + g); region.getPoint(1).y = (int)(top+c+a);
			region.getPoint(2).x = (int)(left    ); region.getPoint(2).y = (int)(top + a);
			region.getPoint(3).x = (int)(left    ); region.getPoint(3).y = (int)(top    );
			break;
		case 19: case 23: case 41: case 45: case 56: case 70: case 82: case 94: case 108: case 113: 
			region.getPoint(0).x = (int)(left + z); region.getPoint(0).y = (int)(top + h);
			region.getPoint(1).x = (int)(left + z); region.getPoint(1).y = (int)(top+h+a);
			region.getPoint(2).x = (int)(left    ); region.getPoint(2).y = (int)(top + a);
			region.getPoint(3).x = (int)(left    ); region.getPoint(3).y = (int)(top    );
			break;
		default:
