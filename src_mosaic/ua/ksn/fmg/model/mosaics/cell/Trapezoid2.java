...
//
// –еализаци€ класса Trapezoid2 - 3 трапеции, составл€ющие равносторонний треугольник
...
/**
 * Trapezoid2 - 3 трапеции, составл€ющие равносторонний треугольник
 * @see BaseCell
 **/
public class Trapezoid2 extends BaseCell {
	public static class AttrTrapezoid2 extends BaseAttribute {
		...
		@Override
		public int getNeighborNumber() { return 9; }
		@Override
	...
	protected void CalcRegion() {
		...
		switch (direction) {
		case 0:
			region.getPoint(0).x = (int)(oX - c  ); region.getPoint(0).y = (int)(oY - R-r);
			region.getPoint(1).x = (int)(oX      ); region.getPoint(1).y = (int)(oY - R  );
			region.getPoint(2).x = (int)(oX - c  ); region.getPoint(2).y = (int)(oY - r  );
			region.getPoint(3).x = (int)(oX - c-a); region.getPoint(3).y = (int)(oY - r  );
			break;                                                            
		case 1:                                                              
			region.getPoint(0).x = (int)(oX + a+c); region.getPoint(0).y = (int)(oY - R-r);
			region.getPoint(1).x = (int)(oX + a  ); region.getPoint(1).y = (int)(oY - R  );
			region.getPoint(2).x = (int)(oX      ); region.getPoint(2).y = (int)(oY - R  );
			region.getPoint(3).x = (int)(oX - c  ); region.getPoint(3).y = (int)(oY - R-r);
			break;                                                            
		case 2:                                                              
			region.getPoint(0).x = (int)(oX + b+c); region.getPoint(0).y = (int)(oY - R-r);
			region.getPoint(3).x = (int)(oX + a+c); region.getPoint(3).y = (int)(oY - R-r);
			region.getPoint(2).x = (int)(oX + a  ); region.getPoint(2).y = (int)(oY - R  );
			region.getPoint(1).x = (int)(oX + a+c); region.getPoint(1).y = (int)(oY - r  );
			break;                                                            
		case 3:                                                              
			region.getPoint(0).x = (int)(oX - c  ); region.getPoint(0).y = (int)(oY - r  );
			region.getPoint(1).x = (int)(oX      ); region.getPoint(1).y = (int)(oY      );
			region.getPoint(2).x = (int)(oX - b  ); region.getPoint(2).y = (int)(oY      );
			region.getPoint(3).x = (int)(oX - a-c); region.getPoint(3).y = (int)(oY - r  );
			break;                                                            
		case 4:                                                              
			region.getPoint(0).x = (int)(oX      ); region.getPoint(0).y = (int)(oY - R  );
			region.getPoint(1).x = (int)(oX + a  ); region.getPoint(1).y = (int)(oY      );
			region.getPoint(2).x = (int)(oX      ); region.getPoint(2).y = (int)(oY      );
			region.getPoint(3).x = (int)(oX - c  ); region.getPoint(3).y = (int)(oY - r  );
			break;                                                            
		case 5:                                                              
			region.getPoint(0).x = (int)(oX + a  ); region.getPoint(0).y = (int)(oY - R  );
			region.getPoint(1).x = (int)(oX + a+c); region.getPoint(1).y = (int)(oY - r  );
			region.getPoint(2).x = (int)(oX + a  ); region.getPoint(2).y = (int)(oY      );
			region.getPoint(3).x = (int)(oX      ); region.getPoint(3).y = (int)(oY - R  );
			break;                                                            
		case 6:                                                              
			region.getPoint(0).x = (int)(oX      ); region.getPoint(0).y = (int)(oY      );
			region.getPoint(1).x = (int)(oX - c  ); region.getPoint(1).y = (int)(oY + r  );
			region.getPoint(2).x = (int)(oX - a-c); region.getPoint(2).y = (int)(oY + r  );
			region.getPoint(3).x = (int)(oX - b  ); region.getPoint(3).y = (int)(oY      );
			break;                                                            
		case 7:                                                              
			region.getPoint(0).x = (int)(oX + a  ); region.getPoint(0).y = (int)(oY      );
			region.getPoint(1).x = (int)(oX      ); region.getPoint(1).y = (int)(oY + R  );
			region.getPoint(2).x = (int)(oX - c  ); region.getPoint(2).y = (int)(oY + r  );
			region.getPoint(3).x = (int)(oX      ); region.getPoint(3).y = (int)(oY      );
			break;                                                            
		case 8:                                                              
			region.getPoint(0).x = (int)(oX + a  ); region.getPoint(0).y = (int)(oY      );
			region.getPoint(1).x = (int)(oX + a+c); region.getPoint(1).y = (int)(oY + r  );
		...
		case 9:                                                              
			region.getPoint(0).x = (int)(oX - c  ); region.getPoint(0).y = (int)(oY + r  );
			region.getPoint(1).x = (int)(oX      ); region.getPoint(1).y = (int)(oY + R  );
			region.getPoint(2).x = (int)(oX - c  ); region.getPoint(2).y = (int)(oY + R+r);
			region.getPoint(3).x = (int)(oX - a-c); region.getPoint(3).y = (int)(oY + r  );
			break;                                                            
		case 10:                                                             
			region.getPoint(0).x = (int)(oX + a  ); region.getPoint(0).y = (int)(oY + R  );
			region.getPoint(1).x = (int)(oX + a+c); region.getPoint(1).y = (int)(oY + R+r);
			region.getPoint(2).x = (int)(oX - c  ); region.getPoint(2).y = (int)(oY + R+r);
			region.getPoint(3).x = (int)(oX      ); region.getPoint(3).y = (int)(oY + R  );
			break;                                                            
		case 11:                                                             
			region.getPoint(0).x = (int)(oX + a+c); region.getPoint(0).y = (int)(oY + r  );
			region.getPoint(1).x = (int)(oX + b+c); region.getPoint(1).y = (int)(oY + R+r);
			region.getPoint(2).x = (int)(oX + a+c); region.getPoint(2).y = (int)(oY + R+r);
			region.getPoint(3).x = (int)(oX + a  ); region.getPoint(3).y = (int)(oY + R  );
			break;
		}
	}
