...
public class Trapezoid1 extends BaseCell {
	...
	protected void CalcRegion() {
		...
		case 2:
			...
			region.getPoint(1).x = (int)(oX + b  ); region.getPoint(1).y = (int)(oY - R  );
		...
		case 4:
			...
			break;
		case 5:
			region.getPoint(0).x = (int)(oX + b  ); region.getPoint(0).y = (int)(oY - R  );
			region.getPoint(1).x = (int)(oX + a  ); region.getPoint(1).y = (int)(oY      );
			region.getPoint(2).x = (int)(oX + c  ); region.getPoint(2).y = (int)(oY - r  );
		...
		case 7:
			...
			region.getPoint(1).x = (int)(oX + c  ); region.getPoint(1).y = (int)(oY + r  );
			region.getPoint(2).x = (int)(oX - c  ); region.getPoint(2).y = (int)(oY + r  );
			region.getPoint(3).x = (int)(oX - a  ); region.getPoint(3).y = (int)(oY      );
			break;
		case 8:
			region.getPoint(0).x = (int)(oX + a  ); region.getPoint(0).y = (int)(oY      );
		...
		case 9:
			region.getPoint(0).x = (int)(oX + c  ); region.getPoint(0).y = (int)(oY + r  );
			region.getPoint(1).x = (int)(oX - c  ); region.getPoint(1).y = (int)(oY + R+r);
			region.getPoint(2).x = (int)(oX - a  ); region.getPoint(2).y = (int)(oY + R  );
			region.getPoint(3).x = (int)(oX - c  ); region.getPoint(3).y = (int)(oY + r  );
			break;
		case 10:
