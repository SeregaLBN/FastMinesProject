...
//
// –еализаци€ класса Triangle3 - треугольник 45∞-90∞-45∞
...
/**
 * “реугольник. ¬ариант 3 - треугольник 45∞-90∞-45∞(квадрат разделЄнный на 4 части) 
 * @see BaseCell
 **/
public class Triangle3 extends BaseCell {
	public static class AttrTriangle3 extends BaseAttribute {
		...
		@Override
		public int getNeighborNumber() { return 14; }
		@Override
	...
	protected void CalcRegion() {
		...
		case 0:
			...
			region.getPoint(1).x = (int)(oX + b); region.getPoint(1).y = (int)(oY + b);
			break;
		case 1:
			region.getPoint(0).x = (int)(oX + a); region.getPoint(0).y = (int)(oY    );
			region.getPoint(2).x = (int)(oX + b); region.getPoint(2).y = (int)(oY + b);
			region.getPoint(1).x = (int)(oX + a); region.getPoint(1).y = (int)(oY + a);
			break;
		case 2:
			region.getPoint(2).x = (int)(oX    ); region.getPoint(2).y = (int)(oY + a);
			region.getPoint(1).x = (int)(oX + b); region.getPoint(1).y = (int)(oY + b);
		...
		case 3:
			region.getPoint(2).x = (int)(oX    ); region.getPoint(2).y = (int)(oY + a);
			region.getPoint(1).x = (int)(oX + a); region.getPoint(1).y = (int)(oY + a);
			region.getPoint(0).x = (int)(oX + b); region.getPoint(0).y = (int)(oY + b);
			break;
		}
	}
