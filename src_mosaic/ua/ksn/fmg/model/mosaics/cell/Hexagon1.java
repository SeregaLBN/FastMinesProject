...
public class Hexagon1 extends BaseCell {
	...
	protected void CalcRegion() {
		...
		case 0:
			...
			region.getPoint(2).x = (int)(oX - b/2); region.getPoint(2).y = (int)(oY + a/2);
			region.getPoint(3).x = (int)(oX - b  ); region.getPoint(3).y = (int)(oY      );
			region.getPoint(4).x = (int)(oX - b  ); region.getPoint(4).y = (int)(oY - a  );
			region.getPoint(5).x = (int)(oX - b/2); region.getPoint(5).y = (int)(oY - a*1.5);
			break;
		case 1:
			region.getPoint(0).x = (int)(oX + b/2); region.getPoint(0).y = (int)(oY + a/2  );
			region.getPoint(1).x = (int)(oX + b/2); region.getPoint(1).y = (int)(oY + a*1.5);
			region.getPoint(2).x = (int)(oX      ); region.getPoint(2).y = (int)(oY + a*2  );
			region.getPoint(3).x = (int)(oX - b/2); region.getPoint(3).y = (int)(oY + a*1.5);
			region.getPoint(4).x = (int)(oX - b/2); region.getPoint(4).y = (int)(oY + a/2  );
			region.getPoint(5).x = (int)(oX      ); region.getPoint(5).y = (int)(oY        );
			break;
		}
	}
