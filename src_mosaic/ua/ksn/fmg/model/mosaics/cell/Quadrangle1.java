...
/**
 * Quadrangle1 - четырЄхугольник 120∞-90∞-60∞-90∞
 * @see BaseCell
 **/
public class Quadrangle1 extends BaseCell {
	...
	protected void CalcRegion() {
		...
		switch (direction) {
		case 0:
			region.getPoint(0).x = (int)(oX - h  ); region.getPoint(0).y = (int)(oY - n-n);
			region.getPoint(1).x = (int)(oX - m  ); region.getPoint(1).y = (int)(oY - n  );
			region.getPoint(2).x = (int)(oX - h-m); region.getPoint(2).y = (int)(oY - n  );
			region.getPoint(3).x = (int)(oX - h-m); region.getPoint(3).y = (int)(oY - n-b);
			break;
		case 1:
			region.getPoint(0).x = (int)(oX      ); region.getPoint(0).y = (int)(oY - n-n);
			region.getPoint(1).x = (int)(oX - m  ); region.getPoint(1).y = (int)(oY - n  );
			region.getPoint(2).x = (int)(oX - h  ); region.getPoint(2).y = (int)(oY - n-n);
			region.getPoint(3).x = (int)(oX - m  ); region.getPoint(3).y = (int)(oY - n-a);
			break;
		case 2:
			region.getPoint(0).x = (int)(oX + m  ); region.getPoint(0).y = (int)(oY - n-b);
			region.getPoint(1).x = (int)(oX + m  ); region.getPoint(1).y = (int)(oY - n  );
			region.getPoint(2).x = (int)(oX - m  ); region.getPoint(2).y = (int)(oY - n  );
			region.getPoint(3).x = (int)(oX      ); region.getPoint(3).y = (int)(oY - n-n);
			break;
		case 3:
			region.getPoint(0).x = (int)(oX - m  ); region.getPoint(0).y = (int)(oY - n  );
			region.getPoint(1).x = (int)(oX - h  ); region.getPoint(1).y = (int)(oY      );
			region.getPoint(2).x = (int)(oX - h-m); region.getPoint(2).y = (int)(oY - n+b);
			region.getPoint(3).x = (int)(oX - h-m); region.getPoint(3).y = (int)(oY - n  );
			break;
		case 4:
			region.getPoint(0).x = (int)(oX - m  ); region.getPoint(0).y = (int)(oY - n  );
			region.getPoint(1).x = (int)(oX      ); region.getPoint(1).y = (int)(oY      );
			region.getPoint(2).x = (int)(oX - m  ); region.getPoint(2).y = (int)(oY - n+a);
			region.getPoint(3).x = (int)(oX - h  ); region.getPoint(3).y = (int)(oY      );
			break;
		case 5:
			region.getPoint(0).x = (int)(oX + m  ); region.getPoint(0).y = (int)(oY - n  );
			region.getPoint(1).x = (int)(oX + m  ); region.getPoint(1).y = (int)(oY - n+b);
			region.getPoint(2).x = (int)(oX      ); region.getPoint(2).y = (int)(oY      );
			region.getPoint(3).x = (int)(oX - m  ); region.getPoint(3).y = (int)(oY - n  );
			break;
		case 6:
			region.getPoint(0).x = (int)(oX - m  ); region.getPoint(0).y = (int)(oY + n-b);
			region.getPoint(1).x = (int)(oX - m  ); region.getPoint(1).y = (int)(oY + n  );
		...
		case 7:
			...
			region.getPoint(1).x = (int)(oX + m  ); region.getPoint(1).y = (int)(oY + n  );
			region.getPoint(2).x = (int)(oX - m  ); region.getPoint(2).y = (int)(oY + n  );
			region.getPoint(3).x = (int)(oX - m  ); region.getPoint(3).y = (int)(oY + n-b);
			break;
		case 8:
			region.getPoint(0).x = (int)(oX + h  ); region.getPoint(0).y = (int)(oY      );
			region.getPoint(1).x = (int)(oX + m  ); region.getPoint(1).y = (int)(oY + n  );
			region.getPoint(2).x = (int)(oX      ); region.getPoint(2).y = (int)(oY      );
			region.getPoint(3).x = (int)(oX + m  ); region.getPoint(3).y = (int)(oY + n-a);
			break;
		...
		case 10:
			region.getPoint(0).x = (int)(oX + m  ); region.getPoint(0).y = (int)(oY + n  );
			region.getPoint(1).x = (int)(oX      ); region.getPoint(1).y = (int)(oY + n+n);
			region.getPoint(2).x = (int)(oX - m  ); region.getPoint(2).y = (int)(oY + n+b);
			region.getPoint(3).x = (int)(oX - m  ); region.getPoint(3).y = (int)(oY + n  );
			break;
		case 11:
			region.getPoint(0).x = (int)(oX + m  ); region.getPoint(0).y = (int)(oY + n  );
			region.getPoint(1).x = (int)(oX + h  ); region.getPoint(1).y = (int)(oY + n+n);
			region.getPoint(2).x = (int)(oX + m  ); region.getPoint(2).y = (int)(oY + n+a);
			region.getPoint(3).x = (int)(oX      ); region.getPoint(3).y = (int)(oY + n+n);
			break;
		}
