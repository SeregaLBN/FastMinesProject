...
public class TrSq2 extends BaseCell {
	...
	protected void CalcRegion() {
		...
		case 1: case 22:
			...
			break;
		case 2: case 23:
			region.getPoint(0).x = (int)(o.x + a+b);  region.getPoint(0).y = (int)(o.y - h  );
			region.getPoint(2).x = (int)(o.x + b  );  region.getPoint(2).y = (int)(o.y - h  );
			region.getPoint(1).x = (int)(o.x + a  );  region.getPoint(1).y = (int)(o.y      );
			break;
		case 3: case 18:
			region.getPoint(0).x = (int)(o.x - h+b);  region.getPoint(0).y = (int)(o.y - b-h);
			region.getPoint(3).x = (int)(o.x - h  );  region.getPoint(3).y = (int)(o.y - b  );
			region.getPoint(2).x = (int)(o.x      );  region.getPoint(2).y = (int)(o.y      );
		...
		case 6: case 27:
			...
			region.getPoint(2).x = (int)(o.x - h  );  region.getPoint(2).y = (int)(o.y + b  );
			region.getPoint(1).x = (int)(o.x      );  region.getPoint(1).y = (int)(o.y + a  );
			break;
		case 7: case 28:
			region.getPoint(0).x = (int)(o.x + a  );  region.getPoint(0).y = (int)(o.y      );
			region.getPoint(3).x = (int)(o.x      );  region.getPoint(3).y = (int)(o.y      );
			region.getPoint(2).x = (int)(o.x      );  region.getPoint(2).y = (int)(o.y + a  );
			region.getPoint(1).x = (int)(o.x + a  );  region.getPoint(1).y = (int)(o.y + a  );
			break;
		case 8: case 29:
			region.getPoint(0).x = (int)(o.x + b  );  region.getPoint(0).y = (int)(o.y - h  );
			region.getPoint(1).x = (int)(o.x + a  );  region.getPoint(1).y = (int)(o.y      );
		...
		case 11: case 26:
			region.getPoint(0).x = (int)(o.x + a+b);  region.getPoint(0).y = (int)(o.y - h  );
			region.getPoint(1).x = (int)(o.x + a+a);  region.getPoint(1).y = (int)(o.y      );
			region.getPoint(2).x = (int)(o.x + a  );  region.getPoint(2).y = (int)(o.y      );
			break;
		case 12: case 33:
			region.getPoint(0).x = (int)(o.x - h  );  region.getPoint(0).y = (int)(o.y + b  );
			region.getPoint(1).x = (int)(o.x      );  region.getPoint(1).y = (int)(o.y + a  );
			...
			break;
		case 13: case 34:
			region.getPoint(0).x = (int)(o.x      );  region.getPoint(0).y = (int)(o.y + a  );
			region.getPoint(2).x = (int)(o.x - h  );  region.getPoint(2).y = (int)(o.y + a+b);
			region.getPoint(1).x = (int)(o.x      );  region.getPoint(1).y = (int)(o.y + a+a);
			break;
		case 14: case 35:
			region.getPoint(0).x = (int)(o.x + a  );  region.getPoint(0).y = (int)(o.y + a  );
			region.getPoint(3).x = (int)(o.x      );  region.getPoint(3).y = (int)(o.y + a  );
			region.getPoint(2).x = (int)(o.x      );  region.getPoint(2).y = (int)(o.y + a+a);
			region.getPoint(1).x = (int)(o.x + a  );  region.getPoint(1).y = (int)(o.y + a+a);
			break;
		case 15: case 30:
			region.getPoint(0).x = (int)(o.x - h  );  region.getPoint(0).y = (int)(o.y + b  );
			region.getPoint(1).x = (int)(o.x      );  region.getPoint(1).y = (int)(o.y + a  );
		...
		case 16: case 31:
			...
			break;
		case 17: case 32:
			region.getPoint(0).x = (int)(o.x + a+a);  region.getPoint(0).y = (int)(o.y      );
			region.getPoint(3).x = (int)(o.x + a  );  region.getPoint(3).y = (int)(o.y      );
			region.getPoint(2).x = (int)(o.x + a  );  region.getPoint(2).y = (int)(o.y + a  );
			region.getPoint(1).x = (int)(o.x + a+a);  region.getPoint(1).y = (int)(o.y + a  );
			break;
		}
	}
