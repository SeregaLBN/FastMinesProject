...
//			return 1;
	...
	protected void CalcRegion() {
		...
		case 0: case 3: case 7: case 8:
			region.getPoint(0).x = (int)(o.x + a  ); region.getPoint(0).y = (int)(o.y - a*3);
			region.getPoint(1).x = (int)(o.x + a*2); region.getPoint(1).y = (int)(o.y - a*2);
			region.getPoint(2).x = (int)(o.x      ); region.getPoint(2).y = (int)(o.y      );
			region.getPoint(3).x = (int)(o.x - a*2); region.getPoint(3).y = (int)(o.y - a*2);
			region.getPoint(4).x = (int)(o.x - a  ); region.getPoint(4).y = (int)(o.y - a*3);
			break;
		case 1: case 4: case 6: case 10:
			region.getPoint(0).x = (int)(o.x      ); region.getPoint(0).y = (int)(o.y      );
			region.getPoint(1).x = (int)(o.x + a*2); region.getPoint(1).y = (int)(o.y + a*2);
			region.getPoint(2).x = (int)(o.x + a  ); region.getPoint(2).y = (int)(o.y + a*3);
			region.getPoint(3).x = (int)(o.x - a  ); region.getPoint(3).y = (int)(o.y + a*3);
			region.getPoint(4).x = (int)(o.x - a*2); region.getPoint(4).y = (int)(o.y + a*2);
			break;
		case 2: case 11:
			region.getPoint(0).x = (int)(o.x - a*2); region.getPoint(0).y = (int)(o.y - a*2);
			region.getPoint(1).x = (int)(o.x      ); region.getPoint(1).y = (int)(o.y      );
			region.getPoint(2).x = (int)(o.x - a*2); region.getPoint(2).y = (int)(o.y + a*2);
			region.getPoint(3).x = (int)(o.x - a*3); region.getPoint(3).y = (int)(o.y + a  );
			region.getPoint(4).x = (int)(o.x - a*3); region.getPoint(4).y = (int)(o.y - a  );
			break;
		case 5: case 9:
			region.getPoint(0).x = (int)(o.x + a*2); region.getPoint(0).y = (int)(o.y - a*2);
			region.getPoint(1).x = (int)(o.x + a*3); region.getPoint(1).y = (int)(o.y - a  );
			region.getPoint(2).x = (int)(o.x + a*3); region.getPoint(2).y = (int)(o.y + a  );
			region.getPoint(3).x = (int)(o.x + a*2); region.getPoint(3).y = (int)(o.y + a*2);
			region.getPoint(4).x = (int)(o.x      ); region.getPoint(4).y = (int)(o.y      );
			break;
		}
	}
