...
//
// –еализаци€ класса Rhombus1 - 3 ромба, составл€ющие равносторонний шестиугольник
...
/**
 * Rhombus1 - 3 ромба, составл€ющие равносторонний шестиугольник
 * @see BaseCell
 **/
public class Rhombus1 extends BaseCell {
	...
	protected void CalcRegion() {
		...
		case 5:
			region.getPoint(0).x = (int)(oX + a+c); region.getPoint(0).y = (int)(oY - r);
			region.getPoint(1).x = (int)(oX + a+a); region.getPoint(1).y = (int)(oY    );
			region.getPoint(2).x = (int)(oX + a+c); region.getPoint(2).y = (int)(oY + r);
