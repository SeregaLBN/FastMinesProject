...
//
// –еализаци€ класса Parquet1 - паркет в елку (herring-bone parquet)
...
public class Parquet1 extends BaseCell {
	...
	protected void CalcRegion() {
		...
		switch (direction) {
		case 0:
			region.getPoint(0).x = (int) (a * (2 + 2 * coord.x)); region.getPoint(0).y = (int) (a * (0 + 2 * coord.y));
			region.getPoint(1).x = (int) (a * (3 + 2 * coord.x)); region.getPoint(1).y = (int) (a * (1 + 2 * coord.y));
			region.getPoint(2).x = (int) (a * (1 + 2 * coord.x)); region.getPoint(2).y = (int) (a * (3 + 2 * coord.y));
			region.getPoint(3).x = (int) (a * (0 + 2 * coord.x)); region.getPoint(3).y = (int) (a * (2 + 2 * coord.y));
			break;
		case 1:
			region.getPoint(0).x = (int) (a * (1 + 2 * coord.x)); region.getPoint(0).y = (int) (a * (1 + 2 * coord.y));
			region.getPoint(1).x = (int) (a * (3 + 2 * coord.x)); region.getPoint(1).y = (int) (a * (3 + 2 * coord.y));
			region.getPoint(2).x = (int) (a * (2 + 2 * coord.x)); region.getPoint(2).y = (int) (a * (4 + 2 * coord.y));
			region.getPoint(3).x = (int) (a * (0 + 2 * coord.x)); region.getPoint(3).y = (int) (a * (2 + 2 * coord.y));
			break;
		}
	}
