...
//		throw new RuntimeException("Unknown type "+mosaicType);
	...
	{
//		switch (mosaicType) {
//		case eMosaicTriangle1  : return new Triangle1((Triangle1.AttrTriangle1) attr, coord, gContext);
//		//...
//		case eMosaicSquare1    : return new Square1((Square1.AttrSquare1) attr, coord, gContext);
//		//...
//		}
//		throw new RuntimeException("Unknown type "+mosaicType);
