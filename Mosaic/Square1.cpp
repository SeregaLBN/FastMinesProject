...
SIZE nsCell::CSquare1::GetSizeInPixel(const SIZE &sizeField, int iArea) {
   m_a = sqrt(iArea); // размер стороны квадрата
   SIZE result = {sizeField.cx * m_a,
                  sizeField.cy * m_a};
   return result;
}

int nsCell::CSquare1::SizeInscribedSquare(int iArea, int iBorderWidth) {
...
nsCell::CSquare1::CSquare1(const COORD &Coord, const SIZE &sizeField, int iArea, const CGraphicContext &gContext)
...
void nsCell::CSquare1::SetPoint(int iArea) {
