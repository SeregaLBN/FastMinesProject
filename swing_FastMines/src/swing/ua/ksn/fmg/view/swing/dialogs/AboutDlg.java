...
//		System.exit(0);
	...
	private void CreateComponents() {
		// 1. —оздаю панель, котора€ будет содержать все остальные элементы и панели расположени€
		Box boxCenter = Box.createVerticalBox();
		// „тобы интерфейс отвечал требовани€м Java, необходимо отделить его содержимое от границ окна на 12 пикселов. 
		...
		// 2. ѕоочередно создаютс€ "полосы", на которые был разбит интерфейс
		// а) р€д дл€ »конки, Ќазвыѕроги, версии, авторства и лицензии
...
//		panel.setBorder(BorderFactory.createTitledBorder("Logos"));// getDefaultBorder());
	...
	/** тексты Ќазвыѕроги, версии, авторства и лицензии */
...
//				"bgcolor='#FEEF98'" +
		...
		/* ”ниверсальные семейства шрифтов:
		 *     serif Ч шрифты с засечками (антиквенные), типа Times;
		 *     sans-serif Ч рубленные шрифты (шрифты без засечек или гротески), типичный представитель Ч Arial;
		 *     cursive Ч курсивные шрифты;
		 *     fantasy Ч декоративные шрифты;
		 *     monospace Ч моноширинные шрифты, ширина каждого символа в таком семействе одинакова (шрифт Courier).
		 **/
...
//		createRecommendedMargin(new JButton[] { ok } );
	...
	// тестовый метод дл€ проверки диалогового окна
