...
namespace Fmg.Ava.Utils {
    ...
    public static class Cast {
        ...
        public static Avalonia.Size ToAvaSize(this Size self) { return new Avalonia.Size(self.Width, self.Height); }

        public static SizeDouble ToFmSizeDouble(this Avalonia.Size self) { return new SizeDouble(self.Width, self.Height); }
        public static Avalonia.Size ToAvaSize(this SizeDouble self) { return new Avalonia.Size(self.Width, self.Height); }

        public static Rect ToFmRect(this Avalonia.Rect self) { return new Rect((int)self.X, (int)self.Y, (int)self.Width, (int)self.Height); }
        public static Avalonia.Rect ToAvaRect(this Rect self) { return new Avalonia.Rect(self.X, self.Y, self.Width, self.Height); }
        ...
        public static Avalonia.Rect ToAvaRect(this RectDouble self) { return new Avalonia.Rect(self.X, self.Y, self.Width, self.Height); }

        public static Point ToFmPoint(this Avalonia.Point self) { return new Point((int)self.X, (int)self.Y); }
        public static Avalonia.Point ToAvaPoint(this Point self) { return new Avalonia.Point(self.X, self.Y); }

        public static PointDouble ToFmPointDouble(this Avalonia.Point self) { return new PointDouble(self.X, self.Y); }
        public static Avalonia.Point ToAvaPoint(this PointDouble self) { return new Avalonia.Point(self.X, self.Y); }

        public static Color ToFmColor(this Avalonia.Media.Color self) { return new Color(self.A, self.R, self.G, self.B); }
        public static Avalonia.Media.Color ToAvaColor(this Color self) { return new Avalonia.Media.Color(self.A, self.B, self.G, self.R); }

        public static HSV ToHsvColor(this Avalonia.Media.Color self) { return new HSV(self.ToFmColor()); }
        public static Avalonia.Media.Color ToAvaColor(this HSV self) { return self.ToColor().ToAvaColor(); }
