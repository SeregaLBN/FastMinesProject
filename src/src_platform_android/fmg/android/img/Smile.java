...
public final class Smile {
    ...
    /** Smile image. Base image view Android implementation
     * @param <TImage> Android specific image: {@link android.graphics.Bitmap} */
    public abstract static class AndroidView<TImage> extends ImageView<TImage, SmileModel> {

        protected AndroidView(EFaceType faceType) {
    ...
    static class BitmapView extends AndroidView<android.graphics.Bitmap> {
        ...
        public BitmapView(EFaceType faceType) { super(faceType); }
    ...
    /** Smile image controller implementation for {@link BitmapView} */
    public static class BitmapController extends ImageController<android.graphics.Bitmap, BitmapView, SmileModel> {

        public BitmapController(EFaceType faceType) {
            super(new BitmapView(faceType));
        }
