...
public final class Smile {
    ...
    /** Smile images. Base image view JFX implementation
     * @param <TImage> JFX specific image: {@link javafx.scene.image.Image} or {@link javafx.scene.canvas.Canvas}
     */
    public abstract static class JfxView<TImage> extends ImageView<TImage, SmileModel> {

        protected JfxView(EFaceType faceType) {
    ...
    static class CanvasView extends JfxView<javafx.scene.canvas.Canvas> {
        ...
        public CanvasView(EFaceType faceType) { super(faceType); }
    ...
    static class ImageJfxView extends JfxView<javafx.scene.image.Image> {
        ...
        public ImageJfxView(EFaceType faceType) { super(faceType); }
    ...
    /** Smile image controller implementation for {@link Smile.CanvasView} */
    public static class CanvasController extends ImageController<javafx.scene.canvas.Canvas, Smile.CanvasView, SmileModel> {

        public CanvasController(EFaceType faceType) {
            super(new Smile.CanvasView(faceType));
        }
    ...
    /** Smile image controller implementation for {@link Smile.ImageJfxView} */
    public static class ImageJfxController extends ImageController<javafx.scene.image.Image, Smile.ImageJfxView, SmileModel> {

        public ImageJfxController(EFaceType faceType) {
            super(new Smile.ImageJfxView(faceType));
        }
