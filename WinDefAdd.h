...
#define WM_MOSAIC_CLICK          (WM_USER+3) // мозаика уведомл€ет родительское окно о том, что на ней (мозаике) был произведЄн клик
#define WM_MOSAIC_CHANGECOUNTERS (WM_USER+4) // мозаика уведомл€ет родительское окно о изменени€х счЄтчика таймера/мин
#define WM_MOSAIC_GAMENEW        (WM_USER+5) // мозаика уведомл€ет родительское окно о начале новой игры
#define WM_MOSAIC_GAMEBEGIN      (WM_USER+6) // мозаика уведомл€ет родительское окно о старте новой игры
#define WM_MOSAIC_GAMEEND        (WM_USER+7) // мозаика уведомл€ет родительское окно о конце игры
#define WM_MOSAIC_PAUSE          (WM_USER+8) // мозаика уведомл€ет родительское окно о изменении состо€ни€ паузы
...
#define FORWARD_WM_MOSAIC_PAUSE(hwnd, fn) \
   ...
   // ¬ инклюдах 'чистой' VC++6 макроса HANDLE_WM_MOUSEWHEEL и FORWARD_WM_MOUSEWHEEL нет.
   // ќн по€вилс€ в <WindowsX.h>, в какой-то из MS SDK...
   // ƒа и то макрос FORWARD_WM_MOUSEWHEEL определЄн с ошибкой.
   // ѕоэтому пользуюсь своими.
